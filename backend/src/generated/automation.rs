        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/automation.AutomationService/SendCommand",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("automation.AutomationService", "SendCommand"));
...
pub mod automation_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/automation.AutomationService/SendCommand" => {
                    ...
                    struct SendCommandSvc<T: AutomationService>(pub Arc<T>);
                    impl<
                        T: AutomationService,
                    ...
                    for SendCommandSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as AutomationService>::send_command(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    pub const SERVICE_NAME: &str = "automation.AutomationService";
